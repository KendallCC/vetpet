...
export class TablaServiciosComponent implements OnInit{
  ...
  displayedColumns:string[]=['id','nombre','descripcion','tarifa','tiempo_servicio','Tipo_mascota','Especialidad','opciones']
  dataSource: MatTableDataSource<Servicio>;



constructor(public dialog: MatDialog,private router: Router,private services:ServicesService){
